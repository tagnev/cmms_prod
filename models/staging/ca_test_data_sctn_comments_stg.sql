...
with
    ca_test_data_sctn_comments_raw_stg as (
        select * from ca_test_data_sctn_comments_raw
    ),
    exp_recd as (
        select
            *,
        ...
        from ca_test_data_sctn_comments_raw_stg
    ...
    lkptrans as (
        ...
        left outer join
            ...
            -- stg.CXKEY_CAL_TEST_RESLT_NM =raw_stg."Name" AND
            on stg.test_data_id = raw_stg."TestDataSectionID"
